...
namespace EPMS.WebModels.ModelMappers.Inventory.RFI
{
    public static class RfiMapper
    {
        ...
        public static EPMS.Models.DomainModels.RFI CreateRfiClientToServer(this RFIViewModel source)
        {
            var rfi = new EPMS.Models.DomainModels.RFI
            {
                ...
                RecCreatedDate = !string.IsNullOrEmpty(source.Rfi.RecCreatedDateStr) ? DateTime.ParseExact(source.Rfi.RecCreatedDateStr, "dd/MM/yyyy", new CultureInfo("en")) : source.Rfi.RecCreatedDate,
        ...
        public static EPMS.Models.DomainModels.RFI CreateRfiDetailsClientToServer(this WebsiteModels.RFI source)
        {
            var rfi = new EPMS.Models.DomainModels.RFI
            {
                RFIId = source.RFIId,
        ...
        public static WebsiteModels.RFI CreateRfiServerToClient(this EPMS.Models.DomainModels.RFI source)
        {
            var rfi = new WebsiteModels.RFI
            {
                RFIId = source.RFIId,
                FormNumber = source.FormNumber,
                OrderId = source.OrderId,
        ...
        public static WebsiteModels.RFIItem CreateRfiItemServerToClient(this EPMS.Models.DomainModels.RFIItem source)
        {
            var rfiItem = new WebsiteModels.RFIItem
            {
                RFIItemId = source.RFIItemId,
                RFIId = source.RFIId,
                IsItemDescription = source.IsItemDescription,
        ...
        public static WebsiteModels.RFIItem CreateRfiItemDetailsServerToClient(this EPMS.Models.DomainModels.RFIItem source)
        {
            var rfiItem = new WebsiteModels.RFIItem
            {
                RFIItemId = source.RFIItemId,
        ...
        public static WebsiteModels.RFI CreateRfiServerToClientForDropdown(this Models.DomainModels.RFI source)
        {
            var rfi = new WebsiteModels.RFI
            {
                RFIId = source.RFIId,
