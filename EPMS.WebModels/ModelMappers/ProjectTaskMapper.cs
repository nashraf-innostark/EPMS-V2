...
namespace EPMS.WebModels.ModelMappers
{
    public static class ProjectTaskMapper
    {
        ...
        //    };
        //}
        public static Models.ResponseModels.ProjectTaskResponse CreateForDashboard(this ProjectTask source)
        {
            return new Models.ResponseModels.ProjectTaskResponse
            {
                TaskId = source.TaskId,
