...
namespace EPMS.WebModels.ModelMappers.NotificationMapper
{
    public static class NotificationMapper
    {
        ...
        public static Notification CreateFromClientToServer(this NotificationResponse notification)
        {
            var notfication = new Notification
            {
                ...
                ForRole = (int)notification.ForRole,
                IsEmailSent = notification.IsEmailSent,
                IsSMSsent = notification.IsSMSsent,
            ...
            if (notification.NotificationRecipients.Any())
            {
                ...
                else
                {
                    notificationListResponse.Notified = notification.NotificationRecipients.FirstOrDefault().IsRead
                        ? Resources.Notification.Notification.Yes
                        : Resources.Notification.Notification.No;
                }
            }
            
            switch (notification.CategoryId)
            {
                case 1: notificationListResponse.CategoryName = Resources.Notification.Notification.Company; break;
                case 2: notificationListResponse.CategoryName = Resources.Notification.Notification.Documents; break;
                case 3: notificationListResponse.CategoryName = Resources.Notification.Notification.Employees; break;
                case 4: notificationListResponse.CategoryName = Resources.Notification.Notification.Meetings; break;
                case 5: notificationListResponse.CategoryName = Resources.Notification.Notification.Other; break;
                case 6: notificationListResponse.CategoryName = Resources.Notification.Notification.JobApplication; break;
                case 7: notificationListResponse.CategoryName = Resources.Notification.Notification.Inventory; break;
                
                default: notificationListResponse.CategoryName = Resources.Notification.Notification.Other; break;
            }
            switch (notification.AlertBefore)
            {
                case 30: notificationListResponse.AlertTime = Resources.Notification.Notification.BeforeOneMonth; break;
                case 7: notificationListResponse.AlertTime = Resources.Notification.Notification.BeforeOneWeek; break;
                case 1: notificationListResponse.AlertTime = Resources.Notification.Notification.BeforeOneDay; break;
                case 0: notificationListResponse.AlertTime = Resources.Notification.Notification.Instant; break;
                default: notificationListResponse.AlertTime = Resources.Notification.Notification.Before + " " + notification.AlertBefore + " " + Resources.Notification.Notification.Days; break;
            }
        ...
        public static NotificationListResponse CreateFromServerToClientListWithRecipient(this Notification notification, string userId, long employeeId)
        {
            ...
            if (notification.NotificationRecipients.Any())
            {
                ...
                if (notification.NotificationRecipients.FirstOrDefault(x => x.UserId == userId || x.EmployeeId == employeeId)!=null)
                    notificationListResponse.Notified = notification.NotificationRecipients.FirstOrDefault(x => x.UserId == userId || x.EmployeeId == employeeId).IsRead ? Resources.Notification.Notification.Yes : Resources.Notification.Notification.No;
                else
                    //notificationListResponse.Notified = Models.Resources.Notification.No;
                    notificationListResponse.Notified = Resources.Notification.Notification.No;
            }
