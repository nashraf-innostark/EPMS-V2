...
namespace EPMS.Web.ModelMappers.PMS
{
    public static class ProjectTaskMapper
    {
        ...
        public static Models.ProjectTask CreateFromServerToClientEmployee(this ProjectTask source, long employeeId)
        {
            Models.ProjectTask projectTask = new Models.ProjectTask();
            projectTask.TaskId = source.TaskId;
            projectTask.ProjectId = source.ProjectId;
        ...
        public static Models.ProjectTask CreateFromServerToClientCreateForProjectDetails(this ProjectTask source)
        {
            Models.ProjectTask projectTask = new Models.ProjectTask();
            projectTask.TaskId = source.TaskId;
            projectTask.ProjectId = source.ProjectId;
