...
namespace EPMS.Web.Areas.HR.Controllers
{
    ...
    public class EmployeeController : BaseController
    {
        ...
        public ActionResult Create(long? id)
        {
            ...
            {
                EmployeeDetailViewModel viewModel = new EmployeeDetailViewModel();
                // Get Employee Response Along with Employee, Allowance, Requests, Tasks and Job History
        ...
        /// <summary>
        /// Compare new allowance with old to check whether Updated
        /// </summary>
        /// <param name="newAllowance"></param>
        /// <param name="oldAllowance"></param>
        /// <returns></returns>
        ...
        /// <summary>
        /// Get Autogenerated Employee JobId
        /// </summary>
        /// <returns></returns>
