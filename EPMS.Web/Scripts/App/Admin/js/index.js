function showmessage(){
	$.gritter.add({
		...
		image: '/Content/CSS/Admin/img/user2.png',
		sticky: false,
		time: ''
	});
}
$(function () {
    ...
    //setTimeout(showmessage,2000); usman change
...
//    });
    ...
    $('#reportrange').daterangepicker({
     ...
     function (start, end) {
          ...
          filterPrisoners(start.format('MM/DD/YYYY'), end.format('MM/DD/YYYY'));//a custom function
     });
