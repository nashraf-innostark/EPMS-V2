    ...
    public static class NotificationMapper
    {
        ...
        public static Notification CreateFromClientToServer(this NotificationResponse notification)
        {
            var notfication = new Notification
            {
                ...
                AlertBefore = notification.AlertBefore,
                AlertDateType = notification.AlertDateType,
                AlertDate = DateTime.ParseExact(notification.AlertDate, "dd/MM/yyyy", new CultureInfo("ar")),
                AlertAppearDate = DateTime.ParseExact(notification.AlertDate, "dd/MM/yyyy", new CultureInfo("ar")).AddDays(-notification.AlertBefore),
